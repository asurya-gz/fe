  ...
  return (
    <div className="bg-slate-400 min-h-screen">
      ...
      <div className="flex">
        ...
        <div className="mt-8 ml-4">
          <select
            className="bg-amber-400 border-none text-black p-2 rounded-xl text-center outline-none cursor-pointer"
            value={filterOption}
        ...
        <table className="min-w-full">
          ...
          <tbody>
            {filteredTransaksiData.map((transaksi) => (
              ...
              >
                <td className="py-2 px-4">{transaksi.tanggal}</td>
                <td className="py-2 px-4">{transaksi.nama_pembeli}</td>
                <td className="py-2 px-4">Rp. {transaksi.total_harga}</td>
              </tr>
            ))}
          </tbody>
        </table>
